...
* Focusing on what is best for the overall community and scientific accuracy
...
* Misrepresenting simulated or synthetic results as empirically validated
  findings, or otherwise misrepresenting the provenance of numerical results
...
(for non-sensitive matters) or by email to the address listed in
`CITATION.cff`. All complaints will be reviewed and investigated promptly
and fairly.
